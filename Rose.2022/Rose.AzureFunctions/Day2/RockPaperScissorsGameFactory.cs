...
public interface IRockPaperScissorsGameFactory
{
	...
	IRockPaperScissorsGame Create2(string input);
}
...
public class RockPaperScissorsGameFactory : IRockPaperScissorsGameFactory
{
	...
	public IRockPaperScissorsGame Create2(string input)
	{
		return input.Split(' ') switch
		{
			["A", "X"] => new RockPaperScissorsGame(new Rock(), new Scissors()),
			["A", "Y"] => new RockPaperScissorsGame(new Rock(), new Rock()),
			["A", "Z"] => new RockPaperScissorsGame(new Rock(), new Paper()),
			["B", "X"] => new RockPaperScissorsGame(new Paper(), new Rock()),
			["B", "Y"] => new RockPaperScissorsGame(new Paper(), new Paper()),
			["B", "Z"] => new RockPaperScissorsGame(new Paper(), new Scissors()),
			["C", "X"] => new RockPaperScissorsGame(new Scissors(), new Paper()),
			["C", "Y"] => new RockPaperScissorsGame(new Scissors(), new Scissors()),
			["C", "Z"] => new RockPaperScissorsGame(new Scissors(), new Rock()),
			_ => throw new ArgumentOutOfRangeException(nameof(input), input, null),
		};
	}
}
